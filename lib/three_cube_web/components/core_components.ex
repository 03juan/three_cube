defmodule ThreeCubeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ThreeCubeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ThreeCubeWeb.Gettext, "errors", msg, opts)
    # end
